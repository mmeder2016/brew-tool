        ...
        return(
            <nav className="navbar navbar-default" role="navigation">
                <div className="navbar-header">
                    ...
                    <h5 className="navbar-brand navbar-left site-font"><Link to='home' activeClassName='active' data-toggle="collapse" data-target=".navbar-collapse">Site Name Here!</Link></h5>
                </div>
